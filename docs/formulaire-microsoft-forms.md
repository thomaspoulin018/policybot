# Formulaire Microsoft Forms — demande d'utilisation d'un outil d'IAG
...
la source de vérité est `configs/formulaire.yaml`. Régénérer avec
    ...
    policybot devis-formulaire > docs/formulaire-microsoft-forms.md

Conserve les intitulés tels quels dans Microsoft Forms : c'est sur eux que
l'appariement des colonnes de l'export se fait.
